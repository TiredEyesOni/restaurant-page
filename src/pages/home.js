...
import pikachuFoodImage from "../assets/imgs/Pikachu-no-drop-shadow.png";
...
const home = () => {
  ...
  const pikachuFood = document.createElement("img");
  pikachuFood.src = pikachuFoodImage;
  pikachuFood.id = "pikachu-food";
  food.appendChild(pikachuFood);
